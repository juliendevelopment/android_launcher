...
fun GridLayout.canPlace(
    ...
    return items.none { existing ->
        ...
        val xOverlap =
            existing.coords.x < coords.x + span.width &&
                existing.coords.x + existing.span.width > coords.x
        val yOverlap =
            existing.coords.y < coords.y + span.height &&
...
data class GridLayout(
    ...
    fun itemAt(coords: GridCoords): GridItem? =
    ...
    companion object {
        val EMPTY = GridLayout(emptyList())
    }
}
