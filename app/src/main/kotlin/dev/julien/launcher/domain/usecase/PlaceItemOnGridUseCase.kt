 ...
 */
class PlaceItemOnGridUseCase @Inject constructor(
    private val gridRepository: GridRepository,
) {
    suspend fun placeApp(app: AppEntry, target: GridCoords): Boolean {
    ...
    suspend fun moveItem(itemId: Long, target: GridCoords): Boolean {
        val layout = gridRepository.snapshot()
    ...
    suspend fun placeWidget(widget: GridItem.Widget, target: GridCoords): Boolean {
        val layout = gridRepository.snapshot()
