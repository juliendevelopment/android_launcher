...
interface GridItemDao {
    ...
    @Query("SELECT * FROM grid_items")
    suspend fun listItems(): List<GridItemEntity>
    ...
    fun observeAllFolderItems(): Flow<List<FolderItemEntity>>
