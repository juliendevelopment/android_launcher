...
class WidgetRepository @Inject constructor(
    ...
    suspend fun listProviders(): List<WidgetPickerEntry> = withContext(io) {
    ...
    fun bindIntent(appWidgetId: Int, info: AppWidgetProviderInfo, profile: UserHandle? = null) =
    ...
    fun getInfo(appWidgetId: Int): AppWidgetProviderInfo? =
